...
Public Class Common
    ...
    Public Shared Function GetRSSTable() As DataTable
        If Not System.IO.File.Exists(RSSFeed) Then
            ...
            MyRSS.Tables.Add(dt)
            MyRSS.WriteXml(RSSFeed)
            Return dt
        End If

        Dim myDS As DataSet = New DataSet
        myDS.ReadXml(RSSFeed, XmlReadMode.Auto)
    ...
    Public Shared Function GetSavePath(ByVal URL As String) As String
    ...
    Public Shared Function DownloadImage(ByVal URL As String) As Boolean
        Try
    ...
    Public Shared Function LoadDataTable() As DataTable
        DocExists()
    ...
    Public Shared Sub DocExists()
        If (Not System.IO.File.Exists(Document)) Then
            SaveDataTable(GetEmptyTable)
        End If
    End Sub

    Public Shared Sub SaveDataTable(ByVal dt As DataTable)
        Dim ds As New DataSet
        ds.Tables.Add(dt.Copy)
        ds.WriteXml(Document)
    End Sub

    Public Shared Function GetEmptyTable() As DataTable
    ...
    Public Shared ReadOnly Property RSSFeed As String
        Get
    ...
    Public Shared ReadOnly Property Document As String
        Get
            Dim rootWebConfig1 As System.Configuration.Configuration
            rootWebConfig1 = System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration(Nothing)
            If (rootWebConfig1.AppSettings.Settings.Count > 0) Then
    ...
    Public Shared Function GetDocument() As String
        Return Document
    End Function

    Public Shared Function GetRSSFeed() As String
        Return RSSFeed
    End Function
